...
const applicantsList = [
  ...
  //   lastName: "MOHAMMED",
  //   geezFirstName: "አባት",
  //   geezMiddleName: "ኑርጀማል",
  //   geezLastName: "መሀመድ",
  //   dateOfBirth: "2000-10-25",
  //   phoneNumber: "+251984715217",
  //   birthPlace: "Amhara",
  //   gender: 1
  // },
  //    {
  //   firstName: "ABRARAW",
  //   middleName: "GIRMACHEW",
  //   lastName: "WONDAFRASH",
  //   geezFirstName: "አብራራው",
  //   geezMiddleName: "ግርማቸው",
  //   geezLastName: "ወንድአፍራሽ",
  ...
  {
    firstName: "BIRE",
    middleName: "ENDAZENEW",
    lastName: "ABI",
    geezFirstName: "ብሬ",
    geezMiddleName: "እንዳዘነው",
    geezLastName: "አቢ",
    dateOfBirth: "2003-11-23",
    phoneNumber: "+251947784912",
    birthPlace: "Amhara",
    gender: 1
  },
   {
